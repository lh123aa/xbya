...
| P5-B4~B5 | medium 长句对比 / SERP 离线 fixture | ⏳ **未到终态 —— 闭环缺口，尚未做完** | 计划路径见 `tasks-p5.json` 的 `planned_evidence` |
...
"有代码可改 / 从未实测"的已登记项。**闭环尚未宣告**，因为还有 2 项没做完。
